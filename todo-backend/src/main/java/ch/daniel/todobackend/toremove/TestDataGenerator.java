...
public class TestDataGenerator {
	...
	public List<User> createUsers() {
		...
		users.add(new User("Daniel", "1234", "suter_daniel@hotmail.com"));
		users.add(new User("Ilija", "1234", "suter_daniel@hotmail.com"));
		users.add(new User("Nadja", "1234", "suter_daniel@hotmail.com"));
		return users;
	}
}
